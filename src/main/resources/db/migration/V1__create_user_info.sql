...
ALTER TABLE subscriptions_type ADD UNIQUE (product_key);
ALTER TABLE user_payment_info ADD UNIQUE (card_number);
...
INSERT INTO `user_credentials` (`username`,`password`,`user_type_id`) VALUES ('wellingtonxavier@hotmail.com','$2a$10$vOThMLPPEmTeMh64ldRo5u/Z091QaRarNE1r6HObrG5YKpkvGEAJm', 1);